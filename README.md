# MultiAPI - [![GitHub](https://img.shields.io/badge/GitHub-MultiAPI-blue?labelColor=gray&style=flat&link=https://github.com/dmitriykotik/MultiAPI)](https://github.com/dmitriykotik/MultiAPI) [![NuGet](https://img.shields.io/badge/NuGet-v0.1.7-orange?labelColor=gray&style=flat&link=https://www.nuget.org/packages/MultiAPI_Lib)](https://www.nuget.org/packages/MultiAPI_Lib) [![MultiAPI](https://img.shields.io/badge/v0.1.5-stable-green?labelColor=gray&style=flat)]() [![MultiAPI](https://img.shields.io/badge/v0.1.6-stable-green?labelColor=gray&style=flat)]() [![MultiAPI](https://img.shields.io/badge/v0.1.7-stable-green?labelColor=gray&style=flat)]() [![License](https://img.shields.io/badge/License-MIT-blue?labelColor=gray&style=flat)]()
MultiAPI - Это библиотека и сборка разного ПО (Далее "Библиотека") для разработчиков. Она содержит множество функций, чтобы ускорить разработку ПО. MultiAPI подойдёт как начинающим разработчикам, так и профессиональным разработчикам ПО.
...
# Документация
### В данный момент документация не доступна.
